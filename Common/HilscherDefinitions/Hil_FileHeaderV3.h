...
***************************************************************************************
  ...
  $Id: Hil_FileHeaderV3.h 343 2020-11-09 12:24:03Z ABessler $:
  ...
  Changes:
    Date        Description
    -----------------------------------------------------------------------------------
    2020-05-13  - Moved netX90 APP CPU file structures to a common place
                - Added netX90 vector table to NAI file structure
                - Added netX90 NAI/NAE Hboot header to NAI/NAE file structure
