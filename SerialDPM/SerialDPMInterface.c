...
***************************************************************************************
  ...
  $Id: SerialDPMInterface.c 13042 2019-08-07 12:04:40Z Robert $:
...
/*****************************************************************************/
static void* Read_NX50( void* pvDevInstance, void* pvAddr, void* pvData, uint32_t ulLen)
{
...
/*****************************************************************************/
static void* Write_NX50( void* pvDevInstance, void* pvAddr, void* pvData, uint32_t ulLen)
{
  DEVICEINSTANCE* ptDevice  = (DEVICEINSTANCE*) pvDevInstance;
  uint32_t        ulDpmAddr = (uint32_t)pvAddr;
  uint8_t*        pabData   = (uint8_t*)pvData;
...
*   \param ulLen          Number of bytes to read                            */
/*****************************************************************************/
static void* Read_NX500( void* pvDevInstance, void* pvAddr, void* pvData, uint32_t ulLen)
{
  DEVICEINSTANCE* ptDevice      = (DEVICEINSTANCE*) pvDevInstance;
  uint8_t         bUnused       = 0x00;
  uint32_t        ulByteTimeout = 100;
...
*   \param ulLen          Number of bytes to write                           */
/*****************************************************************************/
static void* ReadModifyWrite_NX500( void* pvDevInstance, void* pvAddr, void* pvData, uint32_t ulLen)
{
  uint32_t ulDpmAddr = (uint32_t)pvAddr;
  uint8_t* pabData   = (uint8_t*)pvData;
  uint8_t  abRead[4];
  ...
  if (ulDpmAddr&0x3)
  {
    ...
    (void) Read_NX50( pvDevInstance, (void*)ulAlignedAddr, abRead, 4);
    while (ulPartLen--)
    {
      *pabRead++ = *pabData++;
    }
    (void) Write_NX50( pvDevInstance, (void*)ulAlignedAddr, abRead, 4);
  }

  if (ulLen&~0x3)
  {
    uint32_t ulAlignedLen = ulLen&~0x3;
    (void) Write_NX50( pvDevInstance, (void*)ulDpmAddr, pabData, ulAlignedLen);
  ...
  if (ulLen&0x3)
  {
    ...
    (void) Read_NX50( pvDevInstance, (void*)ulDpmAddr, abRead, 4);
    while (ulLen--)
    {
      *pabRead++ = *pabData++;
    }
    (void) Write_NX50( pvDevInstance, (void*)ulDpmAddr, abRead, 4);
  }
  return pvAddr;
}
...
*   \param ulLen          Number of bytes to read                            */
/*****************************************************************************/
static void* Read_NX10( void* pvDevInstance, void* pvAddr, void* pvData, uint32_t ulLen)
{
  DEVICEINSTANCE* ptDevice = (DEVICEINSTANCE*) pvDevInstance;
  uint8_t         abSend[3];
...
*   \param ulLen          Number of bytes to write                           */
/*****************************************************************************/
static void* Write_NX10( void* pvDevInstance, void* pvAddr, void* pvData, uint32_t ulLen)
{
  DEVICEINSTANCE* ptDevice = (DEVICEINSTANCE*) pvDevInstance;
  uint8_t         abSend[3];
...
*   \param ulLen          Number of bytes to read                            */
/*****************************************************************************/
static void* Read_NX51( void* pvDevInstance, void* pvAddr, void* pvData, uint32_t ulLen)
{
  DEVICEINSTANCE* ptDevice = (DEVICEINSTANCE*) pvDevInstance;
  uint8_t         abSend[4];
...
*   \param ulLen          Number of bytes to write                           */
/*****************************************************************************/
static void* Write_NX51( void* pvDevInstance, void* pvAddr, void* pvData, uint32_t ulLen)
{
  DEVICEINSTANCE* ptDevice = (DEVICEINSTANCE*) pvDevInstance;
  uint8_t         abSend[3];
  ...
  if (CIFX_NO_ERROR == OS_SpiInit(ptDevice->pvOSDependent))
  {
    ...
    switch (iSerDpmType)
    {
      ...
      case SERDPM_NETX10:
        ...
        (void) Read_NX10(ptDevice, 0, &bUnused, 1);
        (void) Read_NX10(ptDevice, 0, &bUnused, 1);
        break;
      case SERDPM_NETX51:
        ...
        /* Initialize SPI unit of slave by making 2 dummy reads */
        (void) Read_NX51(ptDevice, 0, &bUnused, 1);
        (void) Read_NX51(ptDevice, 0, &bUnused, 1);
        break;
      default:
